...
impl Token {
    ...
    pub fn from_command(command: &str) -> Token {
        match command {
            ...
            "oint"   => Token::Integral('∮'),
            // limits are not supported yet, thus ignoring the respective tokens
            "nolimits" => Token::Function(""),
            "limits"   => Token::Function(""),
            ...
            "N"          => Token::Letter('N', Variant::DoubleStruck),
            "R"          => Token::Letter('R', Variant::DoubleStruck),
            "Complex"    => Token::Letter('C', Variant::DoubleStruck),
